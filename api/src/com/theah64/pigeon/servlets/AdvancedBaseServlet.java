...
import com.theah64.pigeon.utils.HeaderSecurity;
...
public abstract class AdvancedBaseServlet extends HttpServlet {
    ...
    protected abstract void doAdvancedPost() throws JSONException, BaseTable.UpdateFailedException, Request.RequestException, BaseTable.InsertFailedException;
